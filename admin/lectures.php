                ...
                <form method="post" class="row g-3">
                    ...
                    <div class="col-12">
                        ...
                        <div class="form-check mb-2">
                            <input class="form-check-input select-all-groups" type="checkbox" id="select_all_lecture_groups">
                            <label class="form-check-label" for="select_all_lecture_groups">Select all groups</label>
                        </div>
                        <div class="row g-2">
                            <?php foreach ($groups as $group): ?>
                                ...
                                <div class="col-md-3">
                                    <div class="form-check">
                                        <input class="form-check-input group-access-checkbox" type="checkbox" name="group_ids[]" value="<?php echo $groupId; ?>" id="group_<?php echo $groupId; ?>" <?php echo $editingLecture && isset($selectedGroupIds[$groupId]) ? 'checked' : ''; ?>>
